<?php
if ( isset( $_GET['filter_tag'], $_GET['filter_category'] ) ) {
require 'views/hub-search.php';
exit;
}
      ...
      <div class="col-md-8">
        ...
        <div class="featured-story story-border-top"
          ...
          <div class="story-badge">
            ...
            <h2>
            <a href="<?= $featuredPost->getPermalink(); ?>"><?= $featuredPost->getTitle(); ?></a>
            </h2>
  ...
  <div class="fellow-section bg-white">
    <div class="container">
      <div class="row">
        ...
        </div><!-- stories-list story-border-top-grey -->
      </div><!-- end row -->
        ...
        <div class="fellows-corner">
          <div class="media col-xs-12 col-lg-3">
            <div class="media-left">
              <a href="https://communitychange.org/author/jchapman/">
            ...
            <div class="media-body">
              ...
              <p>Jeremiah Chapman is a North Carolina-based activist who focuses on raising the voices of people fighting for equality.
          ...
          <div class="media col-xs-12 col-lg-3">
            ...
            <div class="media-body">
              ...
              <p>Wendi C. Thomas is a social justice activist and award-winning journalist from Memphis, Tennessee. <a href="http://www.communitychange.org/author/wthomas/">
              </div>
            </div>
          </div>
          <div class="media col-xs-12 col-lg-3">
            ...
            <div class="media-body">
              ...
              <p>Stephanie is mom to two beautiful girls and their shelter dog, Bodhi. She has worked as a house cleaner and landscaper to make ends meet.
              </p>
            </div>
          </div>
          <div class="media col-xs-12 col-lg-3">
          ...
          <div class="media col-xs-12 col-lg-3">
            ...
            <div class="media-body">
              ...
              <p>Andrea Morales is a Latinx photographer and journalist, who was born in Peru and raised in Miami, Florida.
              </p>
            </div>
          </div>
          <div class="media col-xs-12 col-lg-3">
            <div class="media-left">
              <a href="https://communitychange.org/author/dwellington/">
                <img class="media-object" src="https://communitychange.org/wp-content/uploads/2015/04/darrylw-1.gif" alt="Darryl-Lorenzo-Wellington">
              </a>
            </div>
            <div class="media-body">
              <h4 class="media-heading">Darryl Lorenzo Wellington</h4>
              <p>Darryl is a freelance writer. He has covered post-Katrina New Orleans, poverty exploitation in the plasma industry, and the Charleston massacre.
              </p>
            </div>
          </div>
          <div class="media col-xs-12 col-lg-3">
            ...
            <div class="media-body">
              ...
              <p>Kok-Leong Seow is a DACAmented computer scientist and graduate student at Columbia University.
              </p>
            </div>
          </div>
          <div class="media col-xs-12 col-lg-3">
            ...
            <div class="media-body">
              ...
              <p>Born in Argentina, Thomas Kennedy came to the United States with his parents at the age of ten, first living in New Jersey before settling down in Miami.
              </p>
            </div>
          </div>
          <div class="media col-xs-12 col-lg-3">
            ...
            <div class="media-body">
              ...
              <p>Jamilah Sabur is an interdisciplinary artist who was born in Saint Andrew Parish, Jamaica.
          ...
          <div class="media col-xs-12 col-lg-3">
            ...
            <div class="media-body">
              ...
              <p>Sharisse Tracey is an Army wife in upstate New York, mother of four, educator and writer whose work has appeared in many publications
              </p>
            </div>
          </div>
          <div class="media col-xs-12 col-lg-3">
            ...
            <div class="media-body">
              ...
              <p>Christen Hill is a multimedia journalist and video storyteller with a focus on issues of race, social justice and culture.
              </p>
            </div>
          </div>
          <div class="media col-xs-12 col-lg-3">
            ...
            <div class="media-body">
              ...
              <p>Mikka Macdonald is a writer who focuses on social justice issues. She is a communications professional in Washington, D.C.
              </p>
            </div>
          </div>
